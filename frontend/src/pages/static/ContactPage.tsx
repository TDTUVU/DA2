...
const ContactPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Ở đây sẽ xử lý gửi form liên hệ
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Hãy cho chúng tôi biết bạn cần gì. Đội ngũ của chúng tôi luôn sẵn sàng hỗ trợ bạn 24/7
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="md:w-1/3 bg-blue-600 text-white p-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-white text-blue-600 w-10 h-10 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="flight">Đặt vé máy bay</option>
